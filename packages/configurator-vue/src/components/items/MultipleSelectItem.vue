...
import type { MultipleSelectItem } from '@hayadev/configurator/items';
import { computed, inject, ref } from 'vue';
import { useI18n } from 'vue-i18n';
import ItemLabel from './ItemLabel.vue';
import type { CommonEvents, CommonProps } from './common';

const props = defineProps<CommonProps<MultipleSelectItem>>();

const emit = defineEmits<CommonEvents<MultipleSelectItem>>();
