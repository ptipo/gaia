...
function onClick() {
    ...
    parent.innerHTML=`<pt-form id="pt-form" config=${app.stringifyModel(app.model)} ></pt-form>`
 }

onMounted(async () => {
    // @ts-ignore
    const appModule: any = await import('../../../demo/supa-form/dist/index.js');
...
<template>
    <div class="flex w-full h-full">
        <div class="flex flex-col gap-8 justify-center items-center flex-grow w-full h-full px-4 py-16">
